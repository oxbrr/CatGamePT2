...
{
    // Public class members go here
    public string chickenFilet = "Eggs + milk in bowl mixed. Flour + ingredients together. Cut chicken fillet. Put fillet into flour mix, then into the egg mix, and back into the flour mix. Grill or pan sear.";
...
class Program
{
    ...
    private string tomatoSauce = "1 Crushed tomato and tomato sauce can, combined with onions & your own ingredients.";

    static void Main()
 {
        Program program = new Program();
        program.DisplayTomatoSauce();

        PublicClass myInstance = new PublicClass();
        Console.WriteLine(myInstance.chickenFilet);
    }

    // Example method using the private field
    private void DisplayTomatoSauce()
    {
        PrintWithDelay(tomatoSauce,50);
        // This is the intro kinda thing. Has the Console.WriteLine(), which is just me talking to the player.

        PrintWithDelay("Whats up dude. That was a tomato sauce & chicken fillet recipe my dad taught me.",50);
